...
## [解决方案 2：bind](https://zh.javascript.info/bind#jie-jue-fang-an-2bind)
...
## [部分（应用）函数（Partial functions）](https://zh.javascript.info/bind#bu-fen-ying-yong-han-shu-partialfunctions)
